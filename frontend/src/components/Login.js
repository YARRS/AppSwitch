...
const Login = () => {
  ...
  if (showResetPassword) {
    return (
      <div className="bg-gradient-to-br from-blue-50 via-purple-50 to-pink-50 dark:from-gray-900 dark:via-blue-900/20 dark:to-purple-900/20 flex flex-col justify-center py-12 sm:px-6 lg:px-8 relative overflow-hidden min-h-full">
