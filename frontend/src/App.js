      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16">
          ...
          <div className="hidden md:flex items-center space-x-4">
            ...
            {/* My Orders Icon - Only show for authenticated users */}
            {isAuthenticated && (
              <Link to="/profile?tab=orders" className="group relative p-2 rounded-lg bg-gray-100 dark:bg-gray-800 hover:bg-gray-200 dark:hover:bg-gray-700 transition-all duration-200 hover:shadow-md active:scale-95 transform">
            ...
            <button
              ...
              className="group p-2 rounded-lg bg-gray-100 dark:bg-gray-800 hover:bg-gray-200 dark:hover:bg-gray-700 transition-all duration-200 hover:shadow-md active:scale-95 transform"
            >
              {darkMode ? (
            ...
            {isAuthenticated ? (
              <div className="relative">
                <button
                  ...
                  className="group flex items-center space-x-2 p-2 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-800 transition-all duration-200 hover:shadow-md active:scale-95 transform"
                >
                ...
                {showUserMenu && (
                  <div className="absolute right-0 mt-2 w-48 bg-white dark:bg-gray-800 rounded-xl shadow-xl border border-gray-200 dark:border-gray-700 py-2 z-50 animate-slide-down">
                    <a
                      href="/profile"
                      className="group flex items-center px-4 py-3 text-sm text-gray-700 dark:text-gray-300 hover:bg-blue-50 dark:hover:bg-blue-900/20 hover:text-blue-600 dark:hover:text-blue-400 transition-all duration-200 mx-2 rounded-lg"
                      onClick={() => setShowUserMenu(false)}
                    >
                      <UserIcon className="w-4 h-4 mr-3 group-hover:scale-110 transition-transform duration-200" />
                      Profile
                    </a>
              ...
              <div className="flex items-center space-x-2">
                <a
                  href="/login"
                  className="group flex items-center space-x-1 px-3 py-2 text-sm font-medium text-gray-700 dark:text-gray-300 hover:text-blue-600 dark:hover:text-blue-400 transition-all duration-200 rounded-lg hover:bg-blue-50 dark:hover:bg-blue-900/20"
                >
                ...
                <a
                  href="/register"
                  className="group flex items-center space-x-1 btn-primary btn-animate"
                >
          ...
          <div className="flex md:hidden items-center space-x-2">
            ...
            <Link to="/cart" className="group relative p-3 rounded-xl bg-gray-100 dark:bg-gray-800 hover:bg-gray-200 dark:hover:bg-gray-700 transition-all duration-200 hover:shadow-lg active:scale-95 transform focus:ring-2 focus:ring-blue-500 focus:ring-offset-2">
              <ShoppingCart className="w-5 h-5 text-gray-700 dark:text-gray-300 group-hover:text-blue-600 dark:group-hover:text-blue-400 transition-colors duration-200" />
              {getCartItemCount() > 0 && (
